...
class PhpManager extends BaseManager
{
     ...
     * @see saveToFile()
     */
    public $itemFile = '__ROOT__/admin/common/libs/rbac/items.php';
    /**
     ...
     * @see saveToFile()
     */
    public $assignmentFile = '__ROOT__/admin/common/libs/rbac/assignments.php';
    /**
     ...
     * @see saveToFile()
     */
    public $ruleFile = '__ROOT__/admin/common/libs/rbac/rules.php';
    ...
    public function assign($role, $userId)
    {
        if (!isset($this->items[$role->name])) {
            ...
            throw new Exception("Authorization item '{$role->name}' has already been assigned to user '$userId'.");
        }
    ...
    protected function updateItem($name, $item)
    {
        if ($name !== $item->name) {
            if (isset($this->items[$item->name])) {
                throw new Exception("Unable to change the item name. The name '{$item->name}' is already used by another item.");
            }
